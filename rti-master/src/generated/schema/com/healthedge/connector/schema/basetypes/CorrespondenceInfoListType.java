 ...
 *         &lt;element name="corresppondenceInfo" type="{http://www.healthedge.com/connector/schema/basetypes}CorrespondenceInfoType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CorrespondenceInfoListType {
    ...
    protected List<CorrespondenceInfoType> corresppondenceInfo;
    ...
    /**
     * Gets the value of the corresppondenceInfo property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the corresppondenceInfo property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCorresppondenceInfo().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CorrespondenceInfoType> getCorresppondenceInfo() {
        if (corresppondenceInfo == null) {
            corresppondenceInfo = new ArrayList<CorrespondenceInfoType>();
        }
        return this.corresppondenceInfo;
    }
